# -*- encoding: utf-8 -*-
# stub: asciidoctor 2.0.12 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<erubi>.freeze, ["~> 1.9.0"])
      ...
      s.add_development_dependency(%q<rouge>.freeze, ["~> 3.15.0"])
      ...
      s.add_dependency(%q<erubi>.freeze, ["~> 1.9.0"])
      ...
      s.add_dependency(%q<rouge>.freeze, ["~> 3.15.0"])
