...
* Find the settings to configure the backend cache in the xref:/docs/threescale-adapter.adoc#ossm-threescale-cr_threescale-adapter[Example 3scale configuration options].
