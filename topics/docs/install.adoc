...
- Origin (OKD) 3.11
- istiooc (https://github.com/Maistra/origin/releases/tag/v3.11.0%2Bmaistra-0.4.0)
- NOTE: OpenShift Online and OpenShift Dedicated are not supported in the 0.4.0 Istio Tech Preview
