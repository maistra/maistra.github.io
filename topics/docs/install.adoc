...
- Origin (OKD) 3.11
- istiooc (https://github.com/Maistra/origin/releases/tag/v3.11.0%2Bmaistra-0.3.0)
- NOTE: OpenShift Online and OpenShift Dedicated are not supported in the 0.3.0 Istio Tech Preview
...
The templates are available at: https://github.com/Maistra/openshift-ansible/tree/maistra-0.3/istio
