---
title: 3scale WebAssembly Module
type: "document"
...
* The module works with all supported 3scale releases except when configuring a service to use link:https://docs.openshift.com/container-platform/4.9/authentication/identity_providers/configuring-oidc-identity-provider.html#configuring-oidc-identity-provider[OpenID Connect (OIDC)].
