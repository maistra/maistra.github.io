...
If you need to inspect your *OpenShift 4* cluster to debug an issue, you can make use of the `must-gather` tool. It is part of the `oc` CLI tool that comes with OpenShift, so you are not required to install anything else to use it. Basic usage is:
