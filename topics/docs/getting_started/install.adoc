...
Istio CNI plugin is disabled by default. To switch application pod network setup from istio-init Init Container to Istio CNI plugin, set the *enabled* field in the *istio_cni* section to true.
