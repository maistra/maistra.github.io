...
{{% notice info %}}
To use this on an OCP 3.11 cluster, the Red Hat registry must be link:../add-redhat-registry[configured]. The hub must also be set to registry.redhat.io/openshift-istio-tech-preview.
{{% /notice %}}
