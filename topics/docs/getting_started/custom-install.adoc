...
|=======
|Parameter |Description |Default
|secretName|Name of the secret containing the credentials to access the Kiali dashboard. If not provided, the OpenShift authentication strategy will be used | none
