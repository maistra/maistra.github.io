...
For information about how to install the 3scale adapter, refer to the xref:/docs/threescale-adapter.adoc#threescale-adapter[3scale Istio adapter documentation]
...
* xref:/docs/preparing-ossm-installation.adoc#preparing-ossm-installation[Prepare to install {ProductName}] in your {product-title} environment.
