...
Automatic injection of the sidecar is supported by using the _sidecar.istio.io/inject_ annotation within your application yaml file. Set the annotation's value to `true` for injection to occur.
