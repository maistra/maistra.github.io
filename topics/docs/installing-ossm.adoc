...
== Prerequisites
* Follow the xref:/docs/preparing-ossm-installation.adoc#preparing-ossm-installation[Preparing to install {ProductName}] process.
...
* For more information about how {product-title} handled upgrades, refer to the link:https://docs.openshift.com/container-platform/4.6/operators/understanding/olm/olm-understanding-olm.html#olm-overview_olm-understanding-olm[Operator Lifecycle Manager] documentation.

include::modules/ossm-update-app-sidecar.adoc[leveloffset=+2]

== Next steps

* xref:/docs/customizing-installation-ossm.adoc#customize-installation-ossm-v2x[Customize the {ProductName} installation].
