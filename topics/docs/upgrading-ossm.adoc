---
title: Upgrading from 1.1 to 2.0
type: "document"
id: "upgrading-ossm"
weight: 8
---
...
For information about mTLS, see xref:/docs/ossm-security.html#ossm-security-mtls_ossm-security[Enabling mutual Transport Layer Security (mTLS)]
...
Istiod manages client certificates and private keys used by service proxies. By default, Istiod uses a self-signed certificate for signing, but you can configure a custom certificate and private key. For more information about how to configure signing keys, see xref:/docs/ossm-security.adoc#ossm-cert-manage_ossm-security[Adding an external certificate authority key and certificate]
...
Some components support resource limiting and scheduling. For more information, see xref:/docs/ossm-performance-scalability.adoc#ossm-performance-scalability[Performance and scalability].
