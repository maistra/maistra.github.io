...
|username
|username to use with Kiali. Note that this is not related to any account on OpenShift
|
|

|password
|password to use with Kiali. Note that this is not related to any account on OpenShift.
|
|
